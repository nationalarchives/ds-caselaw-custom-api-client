...
class TestDocumentMetadata:
    ...
    def test_legacy_name_and_categories_keys_proxy_to_schema_keys(self, mock_api_client):
        ...
        with pytest.warns(DeprecationWarning, match=r'metadata\["category"\] is deprecated'):
            assert document.metadata["category"] is document.metadata["categories"]
        ...
        with pytest.warns(DeprecationWarning, match=r'metadata\["category"\] is deprecated'):
            assert document.metadata.get("category") is document.metadata["categories"]
