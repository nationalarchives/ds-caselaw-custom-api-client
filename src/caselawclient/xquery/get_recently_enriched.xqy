...
xdmp:to-json(xdmp:sql(
  "SELECT *, process_data.uri, hours_since_enrichment_request, transform_time, enrich_major_version, enrich_minor_version
  FROM (
    SELECT 
      process_data.uri,
      transform_time, enrich_major_version, enrich_minor_version,
