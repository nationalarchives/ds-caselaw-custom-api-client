...
xdmp:to-json(xdmp:sql(
  "SELECT process_data.uri, hours_since_parse_request, parser_major_version, parser_minor_version, transform_time
  FROM (
    SELECT 
      process_data.uri, parser_major_version, parser_minor_version, transform_time, 
