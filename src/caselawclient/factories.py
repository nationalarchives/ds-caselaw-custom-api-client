...
def build_document_body_xml(
    *,
    ...
    jurisdiction: str = "",
    document_date_as_string: str = "2023-02-03",
    case_number: str = "",
) -> str:
    date_attribute = f' date="{document_date_as_string}"' if document_date_as_string else ""
...
DEFAULT_DOCUMENT_BODY_XML = build_document_body_xml()
